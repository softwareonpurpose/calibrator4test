...
public class VerifierTest {
    ...
    public void sameBooleanValue() {
        Assert.assertEquals(Verifier.construct("Boolean", true, true, IndentManager.construct()).verify(), PASS,
    ...
    public void nullBooleanBoolean() {
        ...
        Assert.assertEquals(Verifier.construct("Boolean", null, true, IndentManager.construct()).verify(), String
    ...
    public void nullActualBoolean() {
        ...
        Assert.assertEquals(Verifier.construct("Boolean", false, null, IndentManager.construct()).verify(),
    ...
    public void booleanDiscrepancy() {
        ...
        Assert.assertEquals(Verifier.construct("Boolean", false, true, IndentManager.construct()).verify(),
    ...
    public void sameIntegerValue() {
        ...
        Assert.assertEquals(Verifier.construct("Integer", 1, 1, IndentManager.construct()).verify(), PASS,
                failureMessage);
    }
    ...
    public void nullExpectedInteger() {
        ...
        Assert.assertEquals(Verifier.construct("Integer", null, 1, IndentManager.construct()).verify(), String
                .format("%s -- Expected: <null>  Actual: %d%n", "Integer", 1), failureMessage);
    }

    @Test
    public void nullActualInteger() {
        Assert.assertEquals(Verifier.construct("Integer", 1, null, IndentManager.construct()).verify(), String
    ...
    public void integerDiscrepancy() {
        ...
        Assert.assertEquals(Verifier.construct("Integer", 1, 2, IndentManager.construct()).verify(), String
    ...
    public void sameLongValue() {
        ...
        Assert.assertEquals(Verifier.construct("Long", 1L, 1L, IndentManager.construct()).verify(), PASS,
                failureMessage);
    }
    ...
    public void nullExpectedLong() {
        ...
        Assert.assertEquals(Verifier.construct("Long", null, 1L, IndentManager.construct()).verify(), String
    ...
    public void nullActualLong() {
        ...
        Assert.assertEquals(Verifier.construct("Long", 1L, null, IndentManager.construct()).verify(), String
    ...
    public void longDiscrepancy() {
        ...
        Assert.assertEquals(Verifier.construct("Long", 1L, 2L, IndentManager.construct()).verify(), String.format
                ("%s -- Expected: %d  Actual: %d%n", "Long", 1L, 2L), failureMessage);
    }

    @Test
    public void sameStringValue() {
        Assert.assertEquals(Verifier.construct("String", "test string", "test string", IndentManager.construct())
    ...
    public void nullExpectedString() {
        ...
        Assert.assertEquals(Verifier.construct("String", null, "test string", IndentManager.construct()).verify()
    ...
    public void nullActualString() {
        ...
        Assert.assertEquals(Verifier.construct("String", "test string", null, IndentManager.construct()).verify()
                , String.format("%s -- Expected: %s  Actual: <null>%n", "String", "test string"), failureMessage);
    }

    @Test
    public void stringDiscrepancy() {
        Assert.assertEquals(Verifier.construct("String", "test string", "string test", IndentManager.construct())
    ...
    public void nullExpectedStringList() {
        ...
        Assert.assertEquals(Verifier.construct("String", null, actualStringList, IndentManager.construct())
    ...
    public void nullActualStringList() {
        ...
        Assert.assertEquals(Verifier.construct("String List", expectedStringList, null, IndentManager.construct()
