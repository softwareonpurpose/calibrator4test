...
public class VerifierTest {
    ...
    public void sameBooleanValue() {
        Assert.assertEquals(Verifier.verify("Boolean", true, true, IndentManager.getInstance()), PASS,
    ...
    public void nullBooleanBoolean() {
        ...
        Assert.assertEquals(Verifier.verify("Boolean", null, true, IndentManager.getInstance()), String
    ...
    public void nullActualBoolean() {
        ...
        Assert.assertEquals(Verifier.verify("Boolean", false, null, IndentManager.getInstance()),
    ...
    public void booleanDiscrepancy() {
        ...
        Assert.assertEquals(Verifier.verify("Boolean", false, true, IndentManager.getInstance()),
    ...
    public void sameIntegerValue() {
        ...
        Assert.assertEquals(Verifier.verify("Integer", 1, 1, IndentManager.getInstance()), PASS,
                failureMessage);
    }
    ...
    public void nullExpectedInteger() {
        ...
        Assert.assertEquals(Verifier.verify("Integer", null, 1, IndentManager.getInstance()), String
                .format("%s -- Expected: <null>  Actual: %d%n", "Integer", 1), failureMessage);
    }

    @Test
    public void nullActualInteger() {
        Assert.assertEquals(Verifier.verify("Integer", 1, null, IndentManager.getInstance()), String
    ...
    public void integerDiscrepancy() {
        ...
        Assert.assertEquals(Verifier.verify("Integer", 1, 2, IndentManager.getInstance()), String
    ...
    public void sameLongValue() {
        ...
        Assert.assertEquals(Verifier.verify("Long", 1L, 1L, IndentManager.getInstance()), PASS,
                failureMessage);
    }
    ...
    public void nullExpectedLong() {
        ...
        Assert.assertEquals(Verifier.verify("Long", null, 1L, IndentManager.getInstance()), String
    ...
    public void nullActualLong() {
        ...
        Assert.assertEquals(Verifier.verify("Long", 1L, null, IndentManager.getInstance()), String
    ...
    public void longDiscrepancy() {
        ...
        Assert.assertEquals(Verifier.verify("Long", 1L, 2L, IndentManager.getInstance()),
                String.format("%s -- Expected: %d  Actual: %d%n", "Long", 1L, 2L), failureMessage);
    }

    @Test
    public void sameStringValue() {
        Assert.assertEquals(Verifier.verify("String", "test string", "test string", IndentManager.getInstance()),
                PASS, "Same String values return expected message");
    }

    @Test
    public void nullExpectedString() {
        String failureMessage = "Null 'Expected' String returns Expected = <null>";
        Assert.assertEquals(Verifier.verify("String", null, "test string", IndentManager.getInstance())
    ...
    public void nullActualString() {
        ...
        Assert.assertEquals(Verifier.verify("String", "test string", null, IndentManager.getInstance())
                , String.format("%s -- Expected: %s  Actual: <null>%n", "String", "test string"), failureMessage);
    }

    @Test
    public void stringDiscrepancy() {
        Assert.assertEquals(Verifier.verify("String", "test string", "string test", IndentManager.getInstance()),
    ...
    public void sameStringList() {
        ...
        Assert.assertEquals(Verifier.verify("String List", expectedStringList, actualStringList, IndentManager
                .getInstance()), PASS, "Same String values return expected message");
    }
    ...
    public void nullExpectedStringList() {
        ...
        Assert.assertEquals(Verifier.verify("String", null, actualStringList, IndentManager.getInstance()),
                String.format("%s -- Expected: <null>  Actual: %s%n", "String", flatActualStringList),
    ...
    public void nullActualStringList() {
        ...
        Assert.assertEquals(Verifier.verify("String List", expectedStringList, null, IndentManager.getInstance()),
    ...
    public void stringListDifferentSize() {
        ...
        Assert.assertEquals(Verifier.verify("String List", expectedStringList, actualStringList, IndentManager.getInstance()),
                String.format("%s -- Expected: %s  Actual: %s%n", "String List",
