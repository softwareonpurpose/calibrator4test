...
public class VerifierTest {
    ...
    public void sameBooleanValue() {
        Assert.assertEquals(Verifier.getInstance("Boolean", true, true, IndentManager.getInstance()).verify(), PASS,
    ...
    public void sameIntegerValue() {
        ...
        Assert.assertEquals(Verifier.getInstance("Integer", 1, 1, IndentManager.getInstance()).verify(), PASS,
                failureMessage);
    }
    ...
    public void sameLongValue() {
        ...
        Assert.assertEquals(Verifier.getInstance("Long", 1L, 1L, IndentManager.getInstance()).verify(), PASS,
                failureMessage);
    }
